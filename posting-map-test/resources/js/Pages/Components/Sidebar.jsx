...
const Sidebar = () => {
  ...
  const fetchAreaPrice = (AreasName) => {
    ...
    fetch('http://mapsaervice.create-system.site/', {
      method: 'POST',
      headers: {
  ...
  const sendSelectedAreasToBackend = () => {
    ...
    fetch('http://mapsaervice.create-system.site/order', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'X-CSRF-TOKEN': csrfToken,
      ...
      <div className="w-[160px] bg-gray-800 text-white p-4">
        ...
        {selectedAreas.size > 0 && (
          <div>
            ...
            {/* 送信ボタン */}
            <form method="POST" action="http://mapsaervice.create-system.site/order" className="mt-4">
